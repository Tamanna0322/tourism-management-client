        ...
        <div>
            ...
            >
                ...
                <SwiperSlide className=' text-center mb-6'>
                    <div className='bg-green-900 bg-center bg-no-repeat lg:w-full lg:h-[580px] h-[400px] rounded-3xl bg-cover' style={{ backgroundImage: `linear-gradient(to bottom, rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url(${sundarban})` }}>
                ...
                <SwiperSlide className=' text-center mb-6'>
                    <div className='bg-green-900 bg-center bg-no-repeat lg:w-full lg:h-[580px] h-[400px] rounded-3xl bg-cover object-cover' style={{ backgroundImage: `linear-gradient(to bottom, rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url(${phuket})` }}>
                        <div className='flex flex-col justify-center h-full'>
                ...
                <SwiperSlide className=' text-center mb-6'>
                    <div className='bg-green-900 bg-center bg-no-repeat lg:w-full lg:h-[580px] h-[400px] rounded-3xl bg-cover' style={{ backgroundImage: `linear-gradient(to bottom, rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url(${bali})` }}>
                        <div className='flex flex-col justify-center h-full'>
                ...
                <SwiperSlide className=' text-center mb-6'>
                    <div className='bg-green-900 bg-center bg-no-repeat lg:w-full lg:h-[580px] h-[400px] rounded-3xl bg-cover' style={{ backgroundImage: `linear-gradient(to bottom, rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url(${saint})` }}>
                        <div className='flex flex-col justify-center h-full'>
                ...
                <SwiperSlide className=' text-center mb-6'>
                    <div className='bg-green-900 bg-center bg-no-repeat lg:w-full lg:h-[580px] h-[400px] rounded-3xl bg-cover' style={{ backgroundImage: `linear-gradient(to bottom, rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url(${vietnam})` }}>
                        <div className='flex flex-col justify-center h-full'>
                ...
                <SwiperSlide className=' text-center mb-6'>
                    <div className='bg-green-900 bg-center bg-no-repeat lg:w-full lg:h-[580px] h-[400px] rounded-3xl bg-cover' style={{ backgroundImage: `linear-gradient(to bottom, rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url(${malaysia})` }}>
                        <div className='flex flex-col justify-center h-full'>
